...
public class SpriteLoader {
    ...
    public static BufferedImage loadWalkBaseFrame(int width, int height) {
        BufferedImage img;
        img = loadFrameOrNull("/assets/00_character_walk.png");    if (img != null) return img;
        img = loadFrameFromFile("assets/00_character_walk.png");   if (img != null) return img;
        img = loadFrameFromFile("../assets/00_character_walk.png");if (img != null) return img;
    ...
    public static BufferedImage[] loadImages(String folderPath, String baseName, int frameCount, BufferedImage fallback) {
        ...
        for (int i = 0; i < frameCount; i++) {
            ...
            BufferedImage f = loadFrameOrNull("/assets/" + fullPath);
            if (f == null) f = loadFrameFromFile("assets/" + fullPath);
            if (f == null) f = loadFrameFromFile("../assets/" + fullPath);
