...
public class TileAssetLoader {
    ...
    //block for creation.
    static{
    TILE_PATHS.put(PlatformType.GRASS, "Resources/Block-Assets/GrassBlock_Assets.png");
    TILE_PATHS.put(PlatformType.DIRT,  "Resources/Block-Assets/DirtBlock_Assets.png");
    TILE_PATHS.put(PlatformType.METAL, "Resources/Block-Assets/IronBlock_Assets.png");
    TILE_PATHS.put(PlatformType.SAND,  "Resources/Block-Assets/SandBlock01_Assets.png");
    TILE_PATHS.put(PlatformType.WOOD,  "Resources/Block-Assets/StoneBlock_Assets.png");
    ...
    public static BufferedImage getTile(PlatformType type) {
        //the console prints are for debug.
        if (!initialized) {
